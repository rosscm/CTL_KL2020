...
# Combine data of unequal row length avoiding repetition or errors by
# filling with NAs
...
# Combine data of unequal column length avoiding repetition or errors by
# filling with NAs
...
# Merge PNGs into single PDF file
